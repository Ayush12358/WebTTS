...
- **Multi-Format Support**:
  ...
  - **PDF (Experimental)**: Basic text extraction for simple PDFs (no images or complex layouts).
...
- **Advanced TTS Engines**:
  ...
  - **Google Cloud TTS**: Premium neural voices (requires API key).
- **Interactive Player**:
...
- **TTS**: Edge TTS WebSocket proxy, Web Speech API, Google Cloud Text-to-Speech
- **Icons**: Lucide React
- **PWA**: `vite-plugin-pwa`
